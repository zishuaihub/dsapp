...
import {areasList} from "../../assets/datasource/areas";

/**
 * Generated class for the AreasSelectPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-areas-select',
  templateUrl: 'areas-select.html',
})

export class AreasSelectPage {
  constructor(protected Picker: PickerController,public navCtrl: NavController, public navParams: NavParams) {
  }
  ionViewDidLoad() {
    console.log('ionViewDidLoad AreasSelectPage');
  }
  private picker;
